...
Loss: 40% Weighted CrossEntropy + 60% Weighted Dice  (gentle refinement)

Loads Phase 1 weights (net_segformer_b2_p1.pth) and fine-tunes at very low LR.
...
# Phase 2 config
NUM_EPOCHS  = 80
LR          = 5e-6      # very low -- gentle refinement
PATIENCE    = 20
CE_WEIGHT   = 0.40
DICE_WEIGHT = 0.60
